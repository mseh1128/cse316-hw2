module.exports = class jTPS {
   ...
   * When this method has compd transaction will be at the top
   * of the stack, it will have been compd, and the counter have
   * been moved accordingly.
   *
   * @param transaction (type=jTPS_Transaction)The custom transaction to be added to
   ...
   *
   * @return (Return type = jTPS_Transaction) The transaction that would be executed if undo is performed, if
   ...
   * is it will return it, if not, it will return null.
   *
   * @return (Return type = jTPS_Transaction) The transaction that would be executed if redo is performed, if
   * there is no transaction to undo, null is returned.
   */
